...
namespace LearnHubApp.Models
{
    public class FormationClient
    {
        ...
        [RegularExpression(@"^\d+ (mois|semaines)$", ErrorMessage = "La durée de la formation doit être spécifiée en mois ou en semaines (par exemple, '3 mois' ou '12 semaines').")]
        ...
        public virtual FormateurClient? Formateur { get; set; }

        public virtual ICollection<ModuleClient>? Modules { get; set; }
